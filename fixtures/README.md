...
**.nap/** is the guide repo with mini-books, napkins, agents. The extension clones this into IDB via the terminal.
...
**nap repo:**
- `30-napkins/0100-delivery-pipeline/mini-book/` — 5-chapter guide to the delivery pipeline
- 3 agents (test-arch, fs-eng, test-eng) with prompts and responses
- `20-architects/001-architect/` with scratch notes
- `30-napkins/0200-crust-validation/` — backlog napkin
